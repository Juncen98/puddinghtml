...
{
strRet = "<%!\n" + 
"public String DoFormatCurrency(java.lang.Object aObject,int NumDigitsAfterDecimal,int UseParensForNegativeNumbers,int GroupDigits) \n" + 
"{\n" + 
"\n" + 
...
var JS_formatFunc = "DoFormatCurrency";
