...
var HELP_DOC = MM.HELP_sbRSStatsTotal;
...
function initializeUI()
{
  ...
  _RecordsetName.pickValue(dwscripts.getRecordsetNameWithPageNav());
...
function findServerBehaviors()
{
  ...
  sbArray = dwscripts.findSBs(MM.LABEL_TitleRSStatsTotal + " (@@RecordsetName@@)");
