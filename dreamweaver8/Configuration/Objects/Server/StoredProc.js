...
function objectTag() 
{
  ...
  if (dom)
  {
    ...
    {    
      ...
      {
      case "JSP":
        serverBehaviorFile = "Callable.htm";
		break;

      case "ASP_VBS":
      case "ASP_JS":
		serverBehaviorFile = "Command.htm";
		break;

      case "ASP.NET_Csharp":
      case "ASP.NET_VB":
        serverBehaviorFile = "StoredProc.htm";        
		break;

      case "ColdFusion":
        serverBehaviorFile = "CFStoredProc.htm";
		break;
...
{
  return getSetupStepsForServerObject(true,false);
}
...
{
  return setupStepsCompletedForServerObject(true);
}
