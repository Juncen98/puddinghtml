...
function objectTag() 
{
  ...
  if (dom)
  {
    ...
    {    
      ...
      case "ASP_JS":
      case "JSP":
        serverBehaviorFile = "Delete Record.htm";
        break;
      ...
      case "ASP.NET_Csharp":
      case "ASP.NET_VB":
        serverBehaviorFile = "DeleteRecord.htm";
		break;
...
//--------------------------------------------------------------------
// FUNCTION:
//   shouldExcludeRecordset
//
// DESCRIPTION:
//   Uses the server model to determine whether or not a recordset
//   is required for this server behavior.
//
// ARGUMENTS:
//   none
//
// RETURNS:
//   true if recordset can be excluded; false otherwise
//--------------------------------------------------------------------
function shouldExcludeRecordset()
{
  var dom = dw.getDocumentDOM();
  if (dom)
  {
...
{
  return getSetupStepsForServerObject(shouldExcludeRecordset());
}
...
{
  return setupStepsCompletedForServerObject(shouldExcludeRecordset());
}