...
function objectTag() 
{
  ...
  if (dom)
  {
    ...
    {    
      ...
      case "ASP_JS":
      case "JSP":
        commandFile = "Update Record.htm";
        break;

      case "ASP.NET_Csharp":
      case "ASP.NET_VB":
        commandFile = "ServerObject-UpdRecASPNet.htm";
        break;      
      case "ColdFusion":
        commandFile = "ServerObject-UpdRecCF.htm";
        break;  
      case "PHP_MySQL":
        commandFile = "ServerObject-UpdRecPHP.htm";
        break;
      ...
      default:
        ...
        commandFile = serverModel + "-UpdRec.htm";        
        break;
      } 
...
function canInsertServerObject(commandFileName)
{
  ...
  if (dwscripts.fileExists(path))
  {
    ...
    if (dom.parentWindow.canInsertObject != null)
    {
