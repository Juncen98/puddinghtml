...
function objectTag() 
{
  ...
  if (dom)
  {
    ...
    {    
      ...
      case "ASP_JS":
      case "JSP":
        commandFile = "Insert Record.htm";
        break;

      case "ASP.NET_Csharp":
      case "ASP.NET_VB":
        commandFile = "ServerObject-InsRecASPNet.htm";
        break;
      case "ColdFusion":
        commandFile = "ServerObject-InsRecCF.htm";
        break;
      case "PHP_MySQL":
        commandFile = "ServerObject-InsRecPHP.htm";
        break;
      ...
      default:
        ...
        commandFile = serverModel + "-InsRec.htm";        
        break;
      } 
...
function canInsertServerObject(commandFileName)
{
  ...
  {
    var dom = dw.getDocumentDOM(path);
    
    if (dom && dom.parentWindow.canInsertObject != null)
    {
      retVal = dom.parentWindow.canInsertObject();
    }
  }
  else
  {
