...
//*************** GLOBAL CONSTANTS *****************
var helpDoc = MM.HELP_objASPNETRadioButtonList;
var gDialogShown = false;

//*************** GLOBAL VARIABLES *****************
// UI Elements
var TEXT_ID, TEXT_TTIP, CBOX_POSTBACK, TEXT_AKEY, TEXT_SELVAL, IMG_CKBOLT;
...
function objectTag() {
  ...
  TEXT_ID.value = dotNetUtils.generateUniqueID("RadioButtonList");
  }
  ...
  dotNetUtils.checkFormTags(MM.LABEL_TitleASPRadioButtonList,infoObj);
  ...
  TAG += '<asp:RadioButtonList';
  
  if (TEXT_ID.value != "")
    TAG += ' id="'+ TEXT_ID.value+'"';
  else
    TAG += ' id="' + dotNetUtils.generateUniqueID("RadioButtonList") + '"';
  ...
  TAG += ' runat="server"></asp:RadioButtonList>';
