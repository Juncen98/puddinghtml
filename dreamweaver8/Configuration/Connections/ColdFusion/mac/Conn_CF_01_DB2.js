...
var HELP_DOC = MM.HELP_DSsettingDB2;
...
var AdvancedSettingsFileName = "../AdvancedSettings/Conn_CF_01_DB2_Adv.htm";
...
function createDatasource(params) {
	...
	executeRequest(buildRequest('cfide.adminapi.datasource', 'setDB2', params, getAdminPassword()));
	return 1;
}
