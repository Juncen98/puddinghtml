...
//TODO-------------------------------------------------------------------
//smathews: Localization Issue: Does this text string need translation
//when working with international versions of Windows??
var udlFileConst = "; Everything after this line is an OLE DB initstring";
...
{
  var returnedValue = formatConnectionString(MM.runDataLinkDialog());
  if(returnedValue != "")
	connStringObject.value = returnedValue;
}
